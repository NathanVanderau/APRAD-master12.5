...
public class RawSignal extends Activity {
  ...
  //}
	...
	private RawSignalView educationVisualizer;
	...
	{
		super.onCreate(savedInstanceState);
		setContentView(R.layout.raw_signal);

		// get the Surface view which is used to draw the spectrum.
		this.educationVisualizer = (RawSignalView) findViewById(R.id.educationSurfaceView);
  ...
  public boolean onOptionsItemSelected( MenuItem item ){
    ...
    case R.id.settings:
      Intent settingsIntent = new Intent( RawSignal.this, Preferences.class );
      settingsIntent.setFlags( Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK );
      this.startActivity(settingsIntent);
      return true;
    case R.id.open_file:
      Intent openSavedDataIntent = new Intent( RawSignal.this, OpenSavedData.class );
