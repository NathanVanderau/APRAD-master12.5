...
public class TimeDomainView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private static final int		SIGNAL_RANGE			= 65000;
    private static final int 		EXPANDE_SCALAR			= 10;
    ...
    private void drawSignalGraph( Canvas canvas, double[] transformedsignal, int maxFFTSample )
    {
        ...
        for(int i = 0; i < SIGNAL_LENGTH/EXPANDE_SCALAR - 1; i++)
